function  loadCategoryLevel(pid,cl,categoryLevel){
	$.ajax({
		type:"GET",//请求类型
		url:"/appinfo/category/getlevel1",//请求的url
		data:{pid:pid},//请求参数
...
function  loadCategoryLevel2(pid,cl,categoryLevel){
		...
		$.ajax({
			...
			data:{queryCategoryLevel1:pid},//请求参数
			dataType:"json",//ajax接口（请求url）返回的数据类型
			success:function(data){//data：返回数据（json对象）
...
function  loadCategoryLevel3(pid,cl,categoryLevel){
	var categoryLevel1 = $("#categoryLevel1").val();
	$.ajax({
		type:"GET",//请求类型
		url:"/appinfo/category/getlevel3",//请求的url
		data:{queryCategoryLevel2:pid},//请求参数
		dataType:"json",//ajax接口（请求url）返回的数据类型
		success:function(data){//data：返回数据（json对象）
...
$(function(){  
	...
	$.ajax({
		type:"GET",//请求类型
		url:"/appinfo/dataDictionary/platform",//请求的url
	...
	//动态加载三级分类列表
	loadCategoryLevel3(cl2,cl3,"categoryLevel3");
	...
	$("#categoryLevel1").change(function(){
		...
		if(categoryLevel1 != '' && categoryLevel1 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/appinfo/category/getlevel2",//请求的url
				data:{queryCategoryLevel1:categoryLevel1},//请求参数
				dataType:"json",//ajax接口（请求url）返回的数据类型
				success:function(data){//data：返回数据（json对象）
					$("#categoryLevel2").html("");
					var options = "<option value=\"\">--请选择--</option>";
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/appinfo/category/getlevel3",//请求的url
				data:{queryCategoryLevel2:categoryLevel2},//请求参数
				dataType:"json",//ajax接口（请求url）返回的数据类型
				success:function(data){//data：返回数据（json对象）
					$("#categoryLevel3").html("");
					var options = "<option value=\"\">--请选择--</option>";
