    ...
    <div class="x_panel">
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
							...
							<c:forEach var="appVersion" items="${appVersionList }" varStatus="status">
								<tr role="row" class="odd">
									...
									<td>
                                        ...
                                        <c:when test="${appVersion.publishStatus == 3}">
                                            审核未通过
                                        </c:when>
                                        <c:when test="${appVersion.publishStatus == 4}">
                                            已上架
                                        </c:when>
                                        <c:when test="${appVersion.publishStatus == 5}">
                                            已下架
                                        </c:when>
                                        <c:otherwise>
                                            这是个假的版本
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath }/app/addversionsave"  method="post" enctype="multipart/form-data">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="versionInfo" name="versionInfo" required="required"    value="${appVersion.versionInfo}"
